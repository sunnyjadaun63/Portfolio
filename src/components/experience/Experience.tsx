...
const experiences: Experience[] = [
  {
    ...
    responsibilities: [
      ...
      "Created immersive 3D experiences and animations using Three.js for interactive web features"
    ],
    tech: ["HTML","CSS", "JavaScript",  "React", "Node.js", "TypeScript", "MongoDB","Three.js"],
  ...
  },
  {
    ...
    current: false,
    description: "Delivered robust Frontend solutions with focus on code quality and user experience",
    responsibilities: [
      "Created reusable component library reducing development time by 25%",
      "Implemented CI/CD pipelines reducing deployment time by 60%",
      "Enhanced application security through implementation of OAuth 2.0 and JWT"
    ],
